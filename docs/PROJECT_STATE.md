...
- WebMCP 핵심 도구 5개 등록 및 브라우저 호출 검증
- 개인정보 안전한 WebMCP 작업 영수증과 여섯 번째 조회 도구 구현
- 자동 테스트 28개, 프로덕션 빌드, 배포 의존성 감사 통과
...
작업 영수증 기능을 검증·통합한 뒤, 저장소 공개 전환과 오픈소스 라이선스 추가 승인을 받아 GitHub Pages 공개 URL을 검증합니다.
...
최근 확인 결과는 테스트 28개 통과, TypeScript + Vite 빌드 통과, 배포 의존성 취약점 0개입니다.
